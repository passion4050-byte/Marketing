...
export function ContactButtons({
  ...
  const wa = (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-none bg-[#25D366] ${pad} text-sm font-bold text-white transition hover:brightness-95 active:scale-[0.98]`}
    >
  ...
  const line = (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-none bg-[#06C755] ${pad} text-sm font-bold text-white transition hover:brightness-95 active:scale-[0.98]`}
    >
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
