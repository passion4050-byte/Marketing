  ...
  return (
    <div className={`flex flex-wrap gap-3 ${className}`}>
      <a
        ...
        className={`inline-flex items-center gap-2 rounded-full bg-[#25D366] ${pad} text-sm font-bold text-white transition hover:brightness-95`}
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className={`inline-flex items-center gap-2 rounded-full bg-[#06C755] ${pad} text-sm font-bold text-white transition hover:brightness-95`}
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
