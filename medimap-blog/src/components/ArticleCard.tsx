  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-center justify-between pt-5 text-xs text-ink-subtle">
        ...
        <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 bg-white transition-all group-hover:border-brand group-hover:bg-brand">
          <svg
