...
export default async function ClientTrafficPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-bold">검색 유입</h1>
        ...
        <>
          ...
          <section className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-4">
            <div className="rounded-xl border border-stone-200 bg-white p-4">
              ...
              <div className="mt-1 text-2xl font-bold">{t.brandImpressions.toLocaleString()}</div>
              <div className="text-[10px] text-stone-400">우리 병원명이 들어간 검색</div>
            </div>
            <div className="rounded-xl border border-stone-200 bg-white p-4">
              <div className="text-[10px] font-semibold uppercase tracking-wider text-stone-400">
                병원명 검색 클릭
              </div>
              <div className="mt-1 text-2xl font-bold">{t.brandClicks.toLocaleString()}</div>
              <div className="text-[10px] text-stone-400">검색 결과에서 우리 글 클릭</div>
            </div>
            <div className="rounded-xl border border-stone-200 bg-white p-4">
              <div className="text-[10px] font-semibold uppercase tracking-wider text-stone-400">
                콘텐츠 검색 노출
              </div>
              <div className="mt-1 text-2xl font-bold">{t.contentImpressions.toLocaleString()}</div>
              <div className="text-[10px] text-stone-400">발행 콘텐츠의 검색 노출</div>
            </div>
            <div className="rounded-xl border border-stone-200 bg-white p-4">
              <div className="text-[10px] font-semibold uppercase tracking-wider text-stone-400">
                콘텐츠 방문
              </div>
              <div className="mt-1 text-2xl font-bold">{t.contentSessions.toLocaleString()}</div>
              <div className="text-[10px] text-stone-400">발행 콘텐츠 방문 세션</div>
            </div>
          </section>
          ...
          <section className="mb-6 rounded-xl border border-stone-200 bg-white">
            <header className="border-b border-stone-100 px-5 py-3.5">
              <h2 className="text-sm font-bold">우리 병원을 찾아본 검색</h2>
          ...
          <section className="mb-6 rounded-xl border border-stone-200 bg-white">
            <header className="border-b border-stone-100 px-5 py-3.5">
              <h2 className="text-sm font-bold">시술 수요 검색</h2>
              <p className="mt-0.5 text-[11px] text-stone-500">
          ...
          <section className="mb-6 rounded-xl border border-stone-200 bg-white">
            <header className="border-b border-stone-100 px-5 py-3.5">
              <h2 className="text-sm font-bold">우리 콘텐츠 방문</h2>
              <p className="mt-0.5 text-[11px] text-stone-500">
          ...
          {/* 기대 안내 */}
          <div className="rounded-xl border border-stone-200 bg-stone-50 p-5 text-xs leading-relaxed text-stone-600">
            <div className="mb-1 text-sm font-bold text-stone-800">이 숫자, 이렇게 읽으세요</div>
            <p>
