...
const TIER_COLORS = {
  // Round 124-D — 레퍼런스 위계 팔레트: 자사=민트, 권위=골드, 플랫폼=아이리스,
  // 경쟁(대량 면적)=페리윙클(은은한 바이올렛 기운) — 다크 베이스와 조화.
  t1: '#15B8A6',      // 위서클 — 민트 (아이덴티티)
  t3: '#E8A33D',      // 권위 — 골드
  t4: '#7C3AED',      // 플랫폼 — 딥 바이올렛
  t5: '#818CF8',      // 외부/경쟁 — 인디고 (Round 124-E: 페리윙클이 너무 은은 → 채도↑)
