      ...
      <div className="flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-xl border border-border bg-white shadow-2xl">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full resize-y rounded-md border border-border bg-white px-3 py-2 text-sm leading-relaxed text-ink focus:border-ink focus:outline-none"
          ...
          <div>
            ...
            <textarea
              ...
              rows={16}
              spellCheck={false}
              className="w-full resize-y rounded-md border border-border bg-surface-subtle/60 px-3 py-2 font-mono text-xs leading-relaxed text-ink focus:border-ink focus:outline-none"
        ...
        <div className="flex items-center justify-end gap-2 border-t border-border bg-surface-subtle/60 px-5 py-3">
          ...
          <button
            ...
            onClick={save}
            disabled={saving}
            className="inline-flex items-center gap-1.5 rounded-md bg-ink px-4 py-1.5 text-xs font-bold text-white transition hover:bg-ink-soft disabled:opacity-50"
          >
    ...
    <div className="space-y-3">
      ...
      <div className="card flex flex-wrap items-center gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-1.5 border-l border-border pl-3">
          ...
          <select
            ...
            className="rounded-md border border-border bg-white px-2 py-1 text-xs font-medium text-ink-soft focus:border-ink focus:outline-none"
          >
        ...
        <div className="ml-auto text-[11px] font-semibold text-ink-muted">
          결과{' '}
      ...
      {viewMode === 'archived' && archivedLoading ? (
        ...
        <div className="card px-6 py-12 text-center text-sm">
          <p className="font-semibold text-status-danger">{archivedError}</p>
          <button
            type="button"
            onClick={() => void fetchArchived()}
            className="mt-3 rounded-md border border-border bg-white px-3 py-1.5 text-xs font-semibold text-ink-soft hover:bg-surface-muted"
          >
            다시 시도
          </button>
        </div>
        ...
        <div className="card overflow-hidden">
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        {isSelf ? (
                          <div className="text-[10px] font-mono font-semibold text-accent-deep">
                            자사
                          </div>
                        ) : q.partner_slug ? (
                        ...
                        <div className="inline-flex items-center gap-1">
                          ...
                          {viewMode === 'live' ? (
                            <button
                              ...
                              className="rounded-md border border-border bg-white p-1.5 text-ink-muted transition hover:border-status-danger/25 hover:bg-status-dangerSoft/40 hover:text-status-danger disabled:opacity-40"
                            >
                              {busy ? (
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded-md border border-accent/30 bg-accent-soft/50 px-2 py-1.5 text-[11px] font-bold text-accent-deep transition hover:bg-accent-soft disabled:opacity-40"
                            >
                              {busy ? (
                                <Loader2 className="h-3.5 w-3.5 animate-spin" />
                              ) : (
          ...
          {/* Pagination footer */}
          <div className="flex items-center justify-between gap-3 border-t border-border bg-surface-subtle/60 px-4 py-2.5 text-[11px]">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="inline-flex items-center gap-1 rounded-md border border-border bg-white px-2 py-1 text-xs font-semibold text-ink-soft transition hover:bg-surface-muted disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-white"
              >
                <ChevronLeft className="h-3 w-3" /> 이전
              </button>
              <span className="px-2 text-xs font-bold text-ink-soft tabular-nums">
                {currentPage}{' '}
                <span className="text-ink-faint">/</span> {totalPages}
              </span>
              <button
                type="button"
